...
class Cinema(db.Model):
    ...
    genre_id = db.Column(db.String(255), ForeignKey('genre.id'), nullable=False)
    director_id = db.Column(db.String(100), ForeignKey('director.id'))
